...
def test_book_resolver_keeps_system_and_user_asset_roots_separate(tmp_path) -> None:
    ...
    (paths.default_catalogue_books_dir / "livre.txt").write_text("sys", encoding="utf-8")
    ...
    assert resolver.resolve(sys_book) == paths.default_catalogue_books_dir / "livre.txt"
